...
## Tree (living tree project tree 2023)
...
About 24% of tips have annotations. Let's use this for ASR:
...
```{r}
tip <- left_join(tip_data, phys_data_ready, by = 'taxid')
```
...
We need a matrix of probabilites:
