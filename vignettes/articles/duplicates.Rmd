...
Duplicates are taxa annotated two or more times in the same spreadsheet.
...
# Plot number of rows with conflicts per dataset
...
```{r}
conflicts_df <- bind_rows(conflicts, .id = 'dataset') 
```
