## Code copied from: https://raw.githubusercontent.com/picrust/picrust2/master/picrust2/Rscripts/castor_hsp.R (original from the authors)
## Check the picrust2 publication and code.
